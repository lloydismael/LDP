...
urlpatterns = [
    ...
    path('admin-tools/imports/', views.bulk_import_dashboard, name='bulk_import_dashboard'),
    path('admin-tools/imports/template/', views.bulk_import_template, name='bulk_import_template'),
